/**
 * Dispositions Services - Application Layer Export
 *
...
/**
 * Dispositions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for dispositions domain.
 */
