/**
 * Entities Services - Application Layer Export
 *
...
/**
 * Entities Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for entities domain.
 */
