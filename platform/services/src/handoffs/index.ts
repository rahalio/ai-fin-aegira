/**
 * Handoffs Services - Application Layer Export
 *
...
/**
 * Handoffs Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for handoffs domain.
 */
